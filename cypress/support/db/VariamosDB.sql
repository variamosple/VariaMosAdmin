...
CREATE FUNCTION "get_daily_unique_visits_metrics" (IN "startdate" date, IN "enddate" date, OUT "char_data" json) RETURNS json LANGUAGE plpgsql AS '
DECLARE
BEGIN
    RETURN QUERY WITH
    daily_visits AS (
...
CREATE FUNCTION "get_daily_visits_metrics" (IN "startdate" date, IN "enddate" date, OUT "char_data" json) RETURNS json LANGUAGE plpgsql AS '
DECLARE
BEGIN
    RETURN QUERY WITH
    daily_visits AS (
...
CREATE FUNCTION "get_monthly_visits_metrics" (IN "startdate" date, IN "enddate" date, OUT "char_data" json) RETURNS json LANGUAGE plpgsql AS '
DECLARE
BEGIN
    RETURN QUERY WITH
   	monthly_visits AS (
...
CREATE FUNCTION "get_top_visited_pages_metrics" (OUT "char_data" json) RETURNS json LANGUAGE plpgsql AS '
DECLARE
BEGIN
    RETURN QUERY WITH
...
CREATE FUNCTION "get_yearly_visits_metrics" (OUT "char_data" json) RETURNS json LANGUAGE plpgsql AS '
DECLARE
BEGIN
    RETURN QUERY WITH
   	yearly_visits  AS (
