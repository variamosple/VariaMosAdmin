    ...
    <section className="p-2 p-md-5">
      ...
      <Tabs defaultActiveKey="how-it-works" className="mb-3">
        <Tab eventKey="how-it-works" title="How it works">
          <h2 className="text-primary-color-contrast play-regular fs-4">
            How it works
          </h2>
        ...
        >
          ...
          <h3 className="text-primary-color-contrast play-regular fs-5">
...
fd_labeling(L).`}
      ...
      <h2 className="text-primary-color-contrast play-bold fs-4">Tutorials</h2>
                ...
                <Col md={9}>
                  <Tab.Content>
                    <Tab.Pane eventKey="MDE" unmountOnExit={true}>
                      <div>
                        <h3 className="text-primary-color- play-bold fs-6 mb-3">
                          1. Defining the concrete and abstract syntax of a
                          modeling language
                        </h3>
                    ...
                    <Tab.Pane eventKey="PLE" unmountOnExit={true}>
                      <div>
                        <h3 className="text-primary-color- play-bold fs-6 mb-3">
                          1. Creation of collaborative projects for product
                          lines
                        </h3>
                        <div className="responsive-video">
                          <iframe
                      ...
                      <div>
                        <h3 className="text-primary-color- play-bold fs-6 mb-3">
                          2. Creation of collaborative projects for product
                          lines with generative artificial intelligence
                        </h3>
                        <div className="responsive-video">
                          <iframe
